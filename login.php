...
<body>
  ...
  <?php
    if(auth()){
        ...
        $email = getUserByEmail($conn, $_POST['username']);

        if($_POST['username'] === $email['email'] && $_POST['password'] === $email['password'])
        {
            $_SESSION['user'] = ['id' => $email['id'],
                                 'nome'=> $email['nome'],
                                 'email'=> $email['email'],
                                 'perm'=> $email['perm']];
        ...
        {
            ?>
            <p style="color:red">Wrong user or password</p>
            <?php
        }
        ?>
        <div class="container">
            ...
            <div class="login">
              <form action="" method="post">
                ...
                <div>
                  ...
                  <a href="registar.php">
                    <button type="button" class="btn btn-light">Registo</button>
                  </a>
                </div>
              </form>
            </div>
